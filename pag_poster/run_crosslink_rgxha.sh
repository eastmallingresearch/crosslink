...
gg_group --inp ${INPFILE}\
         --out ${OUTBASE}_group.loc\
         --map ${OUTBASE}_group.map\
         --log ${OUTBASE}_group.log\
...
gg_map --inp ${OUTBASE}_group.loc\
       --out ${OUTBASE}_${LGNAME}.loc\
       --log ${OUTBASE}_${LGNAME}.log\
       --map ${OUTBASE}_${LGNAME}.map\
       --mstmap ${OUTBASE}_${LGNAME}.mstmap\
       --lg ${LGNAME}\
