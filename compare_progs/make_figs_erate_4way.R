...
#==============>memory
p1 = ggplot(datsum2, aes(x=erate, y=maxvmem, colour=algorithm, shape=algorithm)) + 
...
height=7.5
ptsize=10
tiff("4way_erate.tiff",res=res,width=width*res,height=height*res,compression="lzw",bg="white",pointsize=ptsize)
grid.draw(gtab)
dev.off()
