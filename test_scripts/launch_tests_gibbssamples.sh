...
cd /home/vicker/crosslink/ploscompbiol_data/simdata/test_gibbssamples
...
for X in 1 10 50 100 150 200 250 300
do
    for SAMPLENO in $(seq 161 190)
    do
