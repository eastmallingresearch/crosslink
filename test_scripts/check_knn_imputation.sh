...
# check imputation handles repulsion phase correctly
#
...
#sample data from it
POP_SIZE=40            #simulate genotypes from 200 progeny
PROB_MISSING=0.01       #1% missing data
PROB_ERROR=0.0         #1% genotyping errors
PROB_TYPE_ERR=0.0      #5% marker typing errors (ie confusing lmxll with nnxnp)
